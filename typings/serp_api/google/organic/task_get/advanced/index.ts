...
export type SERP_Item =
    IItem_Answer_Box
    | IItem_Carousel
    | IItem_Multi_Carousel
    | IITem_Featured_Snippet
    | IItem_Google_Flights
    | IItem_Google_Flights
    | IItem_Google_Review
    | IItem_Images
    | IITem_Jobs
    | IItem_Knowledge_graph
    | IItem_Local_Pack
    | IItem_Map
    | IItem_Organic
    | IItem_Paid
    | IITem_People_Also_Ask
    | IItem_Related_Searches
    | IItem_People_Also_Search
    | IItem_Shopping
    | IItem_Top_stories
    | IItem_Twitter
    | IItem_video
    | IITem_Events
    | IItem_Mention_Carousel

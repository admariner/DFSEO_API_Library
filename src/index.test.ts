      ...
      it("should be able to create competitor research", () => {
        ...
        describe("DFSEO DataForSEO Labs API Competitor Research", () => {
          it("should be able to get ranked keywords", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.competitorResearch.rankedKeywords(
                newTask
              )
            );
          });
          it("should be able to get serp competitors", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.competitorResearch.serpCompetitors(
                newTask
              )
            );
          });
          it("should be able to get competitors domain", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.competitorResearch.competitorsDomain(
                newTask
              )
            );
          });
          it("should be able to get domain intersection", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.competitorResearch.domainIntersection(
                newTask
              )
            );
          });
          it("should be able to get subdomains", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.competitorResearch.subdomains(newTask)
            );
          });
          it("should be able to get relevant pages", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.competitorResearch.relevantPages(
                newTask
              )
            );
          });
          it("should be able to get domain rank overview", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.competitorResearch.domainRankOverview(
                newTask
              )
            );
          });
      ...
      it("should bea ble to create market specific analysis", () => {
        ...
        describe("DFSEO DataForSEO Labs API Market Specific Analysis", () => {
          it("should be able to get categories for domain", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.marketSpecificAnalysis.categoriesForDomain(
                newTask
              )
            );
          });
          it("should be able to get keywords for categories", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.marketSpecificAnalysis.keywordsForCategories(
                newTask
              )
            );
          });
          it("should be able to get ranked domains by category", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.marketSpecificAnalysis.rankedDomainsByCategory(
                newTask
              )
            );
          });
      ...
      it("should be able to create keyword research", () => {
        ...
        describe("DFSEO DataForSEO Labs API Keyword Research", () => {
          it("should be able to get related keywords", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.keywordResearch.relatedKeywords(
                newTask
              )
            );
          });
          it("should be able to get keyword suggestsions", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.keywordResearch.keywordSuggestions(
                newTask
              )
            );
          });
          it("should be able to get keyword ideas", async () => {
            dfseoAPICheck(
              await dfseo.dataForSEOLabs.keywordResearch.keywordIdeas(newTask)
            );
          });
        });
      });
      ...
      it("should create similar web", () => {
        ...
        describe("DFSEO Traffic Analytics Similar Web", () => {
          it("should be able to set task", async () => {
            dfseoAPICheck(
              await dfseo.trafficAnalytics.similarWeb.taskPost(newTask)
            );
          });
          ...
          it("should be able to get task", async () => {
            dfseoAPICheck(
              await dfseo.trafficAnalytics.similarWeb.taskGet(taskId)
            );
          });
          it("should be able to get live data", async () => {
            dfseoAPICheck(
              await dfseo.trafficAnalytics.similarWeb.live(newTask)
            );
          });
        });
      });
        ...
        describe("DFSEO Keywords Google Trends", () => {
          it("should be able to create Explore", () => {
            ...
            describe("DFSEO Keywords Google Trends Explore", () => {
              it("should be able to set task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleTrends.explore.taskPost(
                    newTask
                  )
                );
              });
              it("should be able to get ready tasks", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleTrends.explore.tasksReady()
                );
              });
              it("should be able to get task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleTrends.explore.taskGet(taskId)
                );
              });
              it("should be able to get live data", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleTrends.explore.live(newTask)
                );
              });
            });
          });
          ...
          it("should be able to get locations by country", async () => {
            dfseoAPICheck(
              await dfseo.keywordsData.googleTrends.locations("UK")
            );
          });
        ...
        describe("DFSEO Keywords Google Ads", () => {
          it("should be able to create ads traffic by platform", () => {
            ...
            describe("DFSEO Keywords Google Ads Ads Traffic By Platform", () => {
              it("should be able to set task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.adsTrafficByPlatform.taskPost(
                    newTask
                  )
                );
              });
              it("should be able to get ready tasks", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.adsTrafficByPlatform.tasksReady()
                );
              });
              it("should be able to get task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.adsTrafficByPlatform.taskGet(
                    taskId
                  )
                );
              });
              it("should be able to get live data", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.adsTrafficByPlatform.live(
                    newTask
                  )
                );
              });
          ...
          it("should be able to create ads traffic by keywords", () => {
            ...
            describe("DFSEO Keywords Google Ads Ads Traffic By Keywords", () => {
              it("should be able to set task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.adsTrafficByKeywords.taskPost(
                    newTask
                  )
                );
              });
              it("should be able to get ready tasks", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.adsTrafficByKeywords.tasksReady()
                );
              });
              it("should be able to get task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.adsTrafficByKeywords.taskGet(
                    taskId
                  )
                );
              });
              it("should be able to get live data", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.adsTrafficByKeywords.live(
                    newTask
                  )
                );
              });
          ...
          it("should create keywords for category", () => {
            ...
            describe("DFSEO Keywords Google Ads Keywords for Category", () => {
              it("should be able to set task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.keywordsForCategory.taskPost(
                    newTask
                  )
                );
              });
              it("should be able to get ready tasks", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.keywordsForCategory.tasksReady()
                );
              });
              it("should be able to get task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.keywordsForCategory.taskGet(
                    taskId
                  )
                );
              });
              it("should be able to get live data", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.keywordsForCategory.live(
                    newTask
                  )
                );
              });
          ...
          it("should create keywords for keywords", () => {
            ...
            describe("DFSEO Keywords Google Ads Keywords for Keywords", () => {
              it("should be able to set task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.keywordsForKeywords.taskPost(
                    newTask
                  )
                );
              });
              it("should be able to get ready tasks", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.keywordsForKeywords.tasksReady()
                );
              });
              it("should be able to get task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.keywordsForKeywords.taskGet(
                    taskId
                  )
                );
              });
              it("should be able to get live data", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.keywordsForKeywords.live(
                    newTask
                  )
                );
              });
          ...
          it("should create keywords for site", () => {
            ...
            describe("DFSEO Keywords Google Ads Keywords For Site", () => {
              it("should be able to able to set task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.keywordsForSite.taskPost(
                    newTask
                  )
                );
              });
              it("should be able to get ready tasks", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.keywordsForSite.tasksReady()
                );
              });
              it("should be able to get task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.keywordsForSite.taskGet(
                    taskId
                  )
                );
              });
              it("should be able to get live data", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.keywordsForSite.live(
                    newTask
                  )
                );
              });
          ...
          it("should create search volume", () => {
            ...
            describe("DFSEO Keywords Google Ads Search Volume", () => {
              it("should be able to set task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.searchVolume.taskPost(
                    newTask
                  )
                );
              });
              it("should be able to get ready tasks", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.searchVolume.tasksReady()
                );
              });
              it("should be able to get task", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.searchVolume.taskGet(
                    taskId
                  )
                );
              });
              it("should be able to get live data", async () => {
                dfseoAPICheck(
                  await dfseo.keywordsData.googleAds.searchVolume.live(newTask)
                );
              });
            });
          });
            ...
            describe("DFSEO SERP Yandex Organic", () => {
              it("should be able to create live", () => {
                ...
                describe("DFSEO SERP Yandex Organic Live", () => {
                  it("should be able to get regular", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.yandex.organic.live.regular(newTask)
                    );
                  });
                  it("should be able to get html", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.yandex.organic.live.html(newTask)
                    );
                  });
                });
              });
              it("should be able to create task get", () => {
                ...
                describe("DFSEO SERP Yandex Organic Task Get", () => {
                  it("should be able to get regular", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.yandex.organic.taskGet.regular(taskId)
                    );
                  });
                  it("should be able to get html", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.yandex.organic.taskGet.html(taskId)
                    );
                  });
                });
              });
              it("should be able to create task", async () => {
                dfseoAPICheck(
                  await dfseo.serp.yandex.organic.taskPost(newTask)
                );
              });
              it("should be able to get ready tasks", async () => {
            ...
            describe("DFSEO SERP Yahoo Organic", () => {
              it("should be able to create live", () => {
                ...
                describe("DFSEO SERP Yahoo Organic Live", () => {
                  it("should be able to get regular", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.yahoo.organic.live.regular(newTask)
                    );
                  });
                  it("should be able to get html", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.yahoo.organic.live.html(newTask)
                    );
                  });
                });
              });
              it("should be able to create task get", () => {
                describe("DFSEO SERP Yahoo Organic Task Get", () => {
                  it("should be able to get regular", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.yahoo.organic.taskGet.regular(taskId)
                    );
                  });
                  it("should be able to get html", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.yahoo.organic.taskGet.html(taskId)
                    );
                  });
                });
              });
          ...
          it("should be able to create local pack", () => {
            ...
            describe("DFSEO SERP Bing Local Pack", () => {
              it("should be able to create a task", async () => {
                dfseoAPICheck(
                  await dfseo.serp.bing.localPack.taskPost(newTask)
                );
              });
              it("should be able to get ready tasks", async () => {
              ...
              it("should be able to create task get", () => {
                ...
                describe("DFSEO SERP Bing Local Pack Task Get", () => {
                  it("should be able to get regular task", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.bing.localPack.taskGet.regular(taskId)
                    );
                  });
                  it("should be able to get html task", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.bing.localPack.taskGet.html(taskId)
                    );
                  });
                });
              });
              it("should be able to create live", () => {
                ...
                describe("DFSEO SERP Bing Local Pack Live", () => {
                  it("should be able to get live regular", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.bing.localPack.live.regular(newTask)
                    );
                  });
                  it("should be able to get live html", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.bing.localPack.live.html(newTask)
                    );
                  });
                });
              });
            ...
            describe("DFSEO SERP Bing Organic", () => {
              ...
              it("should be able to create task get", () => {
                ...
                describe("DFSEO SERP Bing Organic Task Get", () => {
                  it("should be able to get regular task", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.bing.organic.taskGet.regular(taskId)
                    );
                  });
                  it("should be able to get html task", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.bing.organic.taskGet.html(taskId)
                    );
                  });
                });
              });
              it("should be able to create live", () => {
                ...
                describe("DFSEO SERP Bing Organic Live", () => {
                  it("should be able to get regular live", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.bing.organic.live.regular(newTask)
                    );
                  });

                  it("should be able to get html live", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.bing.organic.live.html(newTask)
                    );
                  });
                });
              });
        ...
        describe("DFSEO SERP Google", () => {
              ...
              it("should create live", () => {
                ...
                describe("DFSEO SERP Google Images Live", () => {
                  it("should be able to get live advanced", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.images.live.advanced(newTask)
                    );
                  });
                  it("should be able to get live html", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.images.live.html(newTask)
                    );
                  });
                });
              });
              it("should create task get", () => {
                ...
                describe("DFSEO SERP Google Images Task Get", () => {
                  it("should be able to get task get advanced", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.images.taskGet.advanced(taskId)
                    );
                  });

                  it("should be able to get task get html", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.images.taskGet.html(taskId)
                    );
                  });
                });
              });
            ...
            describe("DFSEO SERP Google Maps", () => {
              ...
              it("should create live", () => {
                ...
                describe("DFSEO SERP Google Maps Live", () => {
                  it("should be able to get advanced", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.maps.live.advanced(newTask)
                    );
                  });
                });
              });
              it("should create task get", () => {
                ...
                describe("DFSEO SERP Google Maps Task Get", () => {
                  it("should be able to get advanced", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.maps.taskGet.advanced(taskId)
                    );
                  });
                });
              });
            ...
            describe("DFSEO SERP Google News", () => {
              it("should create live", async () => {
                ...
                describe("DFSEO SERP Google News Live", () => {
                  it("should be able to get live advanced", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.news.live.advanced(newTask)
                    );
                  });

                  it("should be able to get live html", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.news.live.html(newTask)
                    );
                  });
                });
              });
              it("should create task get", () => {
                ...
                describe("DFSEO SERP Google Task Get", () => {
                  it("should be able to get task get regular", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.news.taskGet.advanced(taskId)
                    );
                  });

                  it("should be able to get task get html", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.news.taskGet.html(taskId)
                    );
                  });
                });
              });
          ...
          it("should create organic", () => {
            ...
            describe("DFSEO SERP Google Organic", () => {
              it("should be able to make a task", async () => {
                dfseoAPICheck(
                  await dfseo.serp.google.organic.taskPost(newTask)
                );
              });
              it("should be able to get ready tasks", async () => {
              ...
              it("should create live", () => {
                ...
                describe("DFSEO SERP Google Organic Live", () => {
                  it("should be able to get live regular", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.organic.live.regular(newTask)
                    );
                  });
                  it("should be able to get live advanced", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.organic.live.advanced(newTask)
                    );
                  });
                  it("should be able to get live html", async () => {
                    dfseoAPICheck(
                      await dfseo.serp.google.organic.live.html(newTask)
                    );
                  });
                });
              });

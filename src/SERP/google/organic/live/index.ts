import DFSEO from "../../../..";
import {
  ISERP_Google_Organic_Live_Advanced_Post_Response,
  ISERP_Google_Organic_Live_Request
} from "../../../../../typings";
export class TaskLive {
   ...
   */
  regular(
    data: ISERP_Google_Organic_Live_Request[]
  ): Promise<ISERP_Google_Organic_Live_Advanced_Post_Response> {

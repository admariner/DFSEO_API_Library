...
export class GoogleAds {
    ...
    public keywordsForKeywords: KeywordsForKeywords = new KeywordsForKeywords(this.DFSEO);
    public keywordsForCategory: KeywordsForCategory = new KeywordsForCategory(this.DFSEO);
    public adsTrafficByKeywords: AdsTrafficByKeywords = new AdsTrafficByKeywords(this.DFSEO);
    public adsTrafficByPlatform: AdsTrafficByPlatforms = new AdsTrafficByPlatforms(this.DFSEO);
